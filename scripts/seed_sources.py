...
def seed_demo_data(session: Session) -> None:
    ...
    sources = [
        Source(
            ...
            interval_sec=300,
            priority=5,
            tags_json=["breaking", "world"],
            notes="Global breaking news feed",
        ),
        Source(
            ...
            interval_sec=300,
            priority=4,
            tags_json=["newsroom", "us"],
            notes="AP Top Stories",
        ),
        Source(
            name="Mastodon #news",
            type="mastodon",
            ...
            priority=2,
            tags_json=["social"],
            notes="Community-curated news hashtag",
        ),
        Source(
            ...
            interval_sec=300,
            priority=3,
            tags_json=["video", "tech"],
            notes="Google Developers updates",
        ),
    ]
