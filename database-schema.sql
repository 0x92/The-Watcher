...
ALTER TABLE IF NOT EXISTS sources ADD COLUMN IF NOT EXISTS priority INTEGER DEFAULT 0;
ALTER TABLE IF NOT EXISTS sources ADD COLUMN IF NOT EXISTS tags_json JSONB;
ALTER TABLE IF NOT EXISTS sources ADD COLUMN IF NOT EXISTS notes TEXT;
